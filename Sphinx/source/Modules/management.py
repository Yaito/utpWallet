...
class Manejo(QtWidgets.QWidget):
    '''This class is used to initialize the Management Window'''
    ...
    def graphic(self):
        '''This function is used to call dataAnalisys()'''
        dataAnalysis()
        pass
        
    def gocreate(self):
        '''This function is used to go to the Create User Window'''
        self.manageview = NewUser(self)
        self.hide()

    def godelete(self):
        '''This function is used to go to the Delete User Window'''
